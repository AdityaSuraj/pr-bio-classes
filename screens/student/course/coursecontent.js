    ...
    return (
        <View style={{backgroundColor:"white",borderColor:"rgba(0,0,0,0.1)",borderRadius:5,paddingVertical:8,marginVertical:3}}>
            ...
            <View style={{flexDirection:"row",paddingHorizontal:8,paddingBottom:8}}>
                ...
                <View style={{flex:1}}>
                    <Text style={{marginHorizontal:6,fontSize:14,fontWeight:"bold",color:"gray",textTransform:"uppercase"}}>Biology</Text>
...
const CourseContentScreen = ()=>{
    ...
    return (
        ...
        <View style={{flex:1}}>
            <Header pagename={route.params.name} isShowNotiBell={false}/>
            ...
            onRefresh={onRefresh}/>}>
                <View style={{paddingHorizontal:12,paddingVertical:12}}>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                        ...
                        <TouchableOpacity onPress={()=>{navigation.navigate('StudentPDFScreen',{course:route.params.id})}} activeOpacity={0.6}>
                            <Text style={{fontSize:18,paddingVertical:8,fontWeight:"bold",color:colorPrimary,marginLeft:"auto"}}>View All</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                        ...
                        <TouchableOpacity onPress={()=>{navigation.navigate('StudentClassVideoScreen',{course:route.params.id})}} activeOpacity={0.6}>
                            <Text style={{fontSize:18,paddingVertical:8,fontWeight:"bold",color:colorPrimary,marginLeft:"auto"}}>View All</Text>
                        </TouchableOpacity>
                    </View>
                    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
