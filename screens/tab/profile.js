...
function ProfileScreen (){
    ...
    function handleLogout(){
        ...
        deleteFromStorage("studentdetail");
            ...
            onRefresh={onRefresh}/>}>
                <TouchableOpacity onPress={()=>{navigation.navigate('EditProfileScreen')}}>
                    <View style={{flexDirection:"row",alignItems:"center",paddingHorizontal:12,paddingVertical:12}}>
                        <Image source={require("../../assets/videocall.png")} style={{height:76,width:76,borderRadius:90,resizeMode:"contain",backgroundColor:"white"}}/>
                        <Text style={{fontSize:20,marginLeft:14}}>{username == null ? "User Name" : username}</Text>
                ...
                <View style={{paddingHorizontal:12}}>
                    <TouchableHighlight onPress={()=>{navigation.navigate('StudentClassVideoScreen',{course:'free'})}} underlayColor="rgba(0,0,0,0.01)">
                    ...
                    <TouchableHighlight onPress={()=>{navigation.navigate('StudentPDFScreen',{course:"free"})}} underlayColor="rgba(0,0,0,0.01)">
                        <View style={{flexDirection:"row",alignItems:"center",height:64}}>
                    ...
                    <View style={{height:1,backgroundColor:"rgba(0,0,0,0.1)"}}></View>
                    <TouchableHighlight onPress={()=>{navigation.navigate('ContactUsScreen')}} underlayColor="rgba(0,0,0,0.01)">
                        <View style={{flexDirection:"row",alignItems:"center",height:64}}>
                            <Icon name="phone" style={{fontSize:20,marginRight:16}}/>
                            <View>
                                <Text style={{fontSize:18,fontWeight:"bold"}}>Contact Us</Text>
                                <Text style={{fontSize:12,color:"gray"}}>Contact PR Bio Classes</Text>
                            </View>
                            <Icon name="angle-right" style={{marginLeft:"auto",marginRight:12}}/>
                        </View>
                    </TouchableHighlight>
